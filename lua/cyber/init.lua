...
local termBrightBlack = "FF533D7D"
...
M.style = function()
  ...
  highlight(0, "CyberCyan", { fg = cyanS })
  highlight(0, "CyberCyan1", { fg = cyanS1 })
  ...
  highlight(0, "CyberNavy", { fg = navy })
  highlight(0, "CyberNavy1", { fg = navy1 })
  highlight(0, "CyberNavy2", { fg = navy2 })
  highlight(0, "CyberPurple", { fg = purple })
  highlight(0, "CyberPurple1", { fg = purple1 })
  highlight(0, "CyberPurple2", { fg = purple2 })
  highlight(0, "CyberPurple3", { fg = purple3 })
  highlight(0, "CyberPurple4", { fg = purple4 })
  highlight(0, "CyberMagenta", { fg = magenta })
  highlight(0, "CyberMagenta1", { fg = magenta1 })
  highlight(0, "CyberPink", { fg = pink })
  highlight(0, "CyberGold", { fg = gold })
  highlight(0, "CyberGold1", { fg = gold1 })
  highlight(0, "CyberGold2", { fg = gold2 })
  highlight(0, "CyberYellow", { fg = yellow })
  highlight(0, "CyberTermBack", { fg = termBack })
  highlight(0, "CyberTermFore", { fg = termFore })
  highlight(0, "CyberTermBlack", { fg = termBlack })
  highlight(0, "CyberTermRed", { fg = termRed })
  highlight(0, "CyberTermGreen", { fg = termGreen })
  highlight(0, "CyberTermYellow", { fg = termYellow })
  highlight(0, "CyberTermBlue", { fg = termBlue })
  highlight(0, "CyberTermMagenta", { fg = termMagenta })
  highlight(0, "CyberTermCyan", { fg = termCyan })
  highlight(0, "CyberTermWhite", { fg = termWhite })
  highlight(0, "CyberTermBrightBlack", { fg = termBrightBlack })
  highlight(0, "CyberTermBrightRed", { fg = termBrightRed })
  highlight(0, "CyberTermBrightGreen", { fg = termBrightGreen })
  highlight(0, "CyberTermBrightYellow", { fg = termBrightYellow })
  highlight(0, "CyberTermBrightBlue", { fg = termBrightBlue })
  highlight(0, "CyberTermBrightMagenta", { fg = termBrightMagenta })
  highlight(0, "CyberTermBrightCyan", { fg = termBrightCyan })
  highlight(0, "CyberTermBrightWhite", { fg = termBrightWhite })
